"""
Bili 弹幕消息测试（Wave 5 迁移后）

W5 后 bili_messages 已迁移至 ``src/modules/types/bili/``。本测试通过旧路径的
re-export 间接测试，确保向后兼容；同时新测试位于
``tests/modules/types/bili/test_bili_messages.py``（W5 新增）。
"""
