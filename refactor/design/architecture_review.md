...
|---------|---------|---------|---------|------|
| **A-01** | AmaidesuCore 仍承担过多职责 | 🔴 | 核心架构 | ⏳ |
...
5. **代码量控制**：AmaidesuCore 从 641 行精简到 386 行
...
4. **A-01**: 将数据流处理从 Core 移出
5. **A-03**: 统一 Provider 构造函数签名
6. **A-05**: 明确插件和 Provider 的目录结构
