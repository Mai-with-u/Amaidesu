...
> **注意**：本文档是基于旧架构（7 层架构）撰写的历史参考文档。
> 当前项目已重构为 3 域架构（Input Domain / Decision Domain / Output Domain）。
> 本文档于 2026-02-16 从 `tests/UNIT_TEST_SUMMARY.md` 归档至此。
>
> 当前测试目录结构请参考 `tests/README.md`。
