...
class CoreWrapper:
    ...
    async def send_to_maicore(self, message: Any) -> None:
        ...
        """
        await self.event_bus.emit("input.raw_data", message, "read_pingmu_extension")
    ...
    def register_service(self, service_name: str, service: Any) -> None:
        ...
        ScreenMonitorPlugin不注册服务，但需要这个方法用于兼容
        """
    ...
    def get_service(self, service_name: str) -> Any:
        ...
        ScreenMonitorPlugin可能需要remote_stream服务或prompt_context服务
        """
        return self._services.get(service_name)


class ReadPingmuExtension(BaseExtension):
    """
    ReadPingmu插件Extension
    ...
    async def setup(self, event_bus: Any, config: Dict[str, Any]) -> List[Any]:
        ...
        # 延迟导入插件，避免循环依赖
        from src.plugins.read_pingmu.plugin import ScreenMonitorPlugin
        ...
        self.logger.info("ReadPingmuExtension设置完成")
    ...
    async def cleanup(self) -> None:
        ...
        清理Extension
        """
        self.logger.info("ReadPingmuExtension清理中...")
        ...
        self.logger.info("ReadPingmuExtension清理完成")
    ...
    def get_info(self) -> ExtensionInfo:
        ...
        return ExtensionInfo(
            name="read_pingmu",
            version="1.0.0",
            description="ReadPingmu插件Extension包装",
    ...
    def get_dependencies(self) -> List[str]:
        ...
        （可能需要remote_stream服务，但这不是Extension依赖）
        """
        return []


# Extension入口点 - ExtensionManager会查找这个变量
extension_class = ReadPingmuExtension
