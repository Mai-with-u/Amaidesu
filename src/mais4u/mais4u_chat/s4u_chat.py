...
class MessageSenderContainer:
    ...
    def __init__(self, chat_stream: Any, original_message: MessageRecv):
...
class S4UChatManager:
    ...
    def get_or_create_chat(self, chat_stream: Any) -> "S4UChat":
...
class S4UChat:
    def __init__(self, chat_stream: Any):
        """初始化 S4UChat 实例。"""

        self.chat_stream = chat_stream
        self.stream_id = chat_stream.stream_id
        self.stream_name = str(self.stream_id)
