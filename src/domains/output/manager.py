...
from src.domains.output.registry import _HANDLERS
...
class OutputHandlerManager:
    ...
    async def load_from_config(self, config: dict[str, Any], config_service=None):
        ...
        try:
            ...
            self.logger.debug("已导入 providers 包，所有 Handler 应已注册")
        ...
        for output_name in enabled_handlers:
            try:
                ...
                if config_service:
                    handler_config = config_service.get_provider_config_with_defaults(
