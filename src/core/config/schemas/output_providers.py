...
class VTSProviderConfig(BaseModel):
    """VTS输出Provider配置"""
...
class StickerProviderConfig(BaseModel):
    """贴纸输出Provider配置"""
...
class WarudoProviderConfig(BaseModel):
    """Warudo输出Provider配置"""
...
class ObsControlProviderConfig(BaseModel):
    """OBS控制输出Provider配置"""
...
class OmniTTSProviderConfig(BaseModel):
...
class RemoteStreamOutputProviderConfig(BaseModel):
    """远程流输出Provider配置"""
