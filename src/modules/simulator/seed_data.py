...
# unit_price = 礼物标价（金瓜子，1000 金瓜子 = 1 元，B 站常见礼物参考价）；
# SC 类礼物金额走 sc_amount_rmb（人民币元）
